      ...
      <div className="container flex flex-col gap-12 mt-14 lg:mt-28 pb-4">
        <div className="flex flex-col gap-4 lg:gap-6">
          ...
          <div className="grid grid-cols-1 gap-12 md:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:gap-4">
            <div className="rounded-3xl shadow-lg bg-white max-w-full bg-learnplat-third-orange overflow-hidden dark:bg-gray-700">
              <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
                <img className="" src={ArticleImg1} alt="" />
              </a>
              <div className="p-6">
                ...
                <div className="flex dark:text-white items-center justify-between">
                  ...
                  <a
                    href="#"
                    className="text-learnplat-yellow font-semibold text-l"
                  >
                    Read More -{'>'}
                  </a>
                </div>
            ...
            <div className="rounded-3xl shadow-lg bg-white max-w-full bg-learnplat-third-orange overflow-hidden dark:bg-gray-700">
              <a href="#!" data-mdb-ripple="true" data-mdb-ripple-color="light">
                <img className="" src={ArticleImg2} alt="" />
              </a>
              <div className="p-6">
                <h5 className="text-gray-900 text-4xl font-semibold mb-2 dark:text-gray-100">
                  Article title
